...
abstract class AppTextStyle {
  ...
  static TextStyle get title27 =>
      const TextStyle(fontSize: 27, fontWeight: FontWeight.bold);
  static TextStyle get title25 =>
      const TextStyle(fontSize: 25, fontWeight: FontWeight.bold ,color: Color(0xFF40D876) );
  static TextStyle get title20 =>
      const TextStyle(fontSize: 20, fontStyle: FontStyle.italic ,color: Color(0xFF40D876) );
